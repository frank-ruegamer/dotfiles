...
run_once({
	"greenclip daemon",
	"setxkbmap us altgr-intl caps:escape",
	"unclutter",
})
...
-- https://github.com/lcpz/dots/blob/master/bin/screenshot
	...
	awful.key({ altkey }, "Up",
		function()
			os.execute(string.format("amixer -q -D pulse set %s 1%%+", beautiful.volume.channel))
	...
	awful.key({ altkey }, "m",
		function()
			os.execute(string.format("amixer -D pulse set %s toggle",
	...
	awful.key({ modkey }, "u", function() awful.spawn("rofimoji -f '[emojis,arrows]'") end,
		{ description = "run rofimoji", group = "launcher" }),
	awful.key({ modkey }, "i", function() awful.spawn("rofi-idea") end,
	...
	awful.key({ modkey }, "d",
		function()
			awful.spawn(
				"rofi -modi drun,window -show drun -drun-match-fields name,exec -show-icons -sidebar-mode")
		end,
		{ description = "run rofi", group = "launcher" }),
	awful.key({ modkey }, "g",
		function() awful.spawn("rofi -modi jira:rofi-jira,confluence:rofi-confluence -show jira -sidebar-mode") end,
		{ description = "run jira tasks", group = "launcher" }),
	awful.key({ modkey }, "c", function() awful.spawn("rofi-customer") end,
		{ description = "copy inputfolderkey / internalnickname", group = "launcher" }),
	...
	awful.key({ modkey }, "a", function() awful.spawn("rofi-tracker") end,
		{ description = "Manage Tempo trackers", group = "launcher" }),
...
clientkeys = my_table.join(
	...
	awful.key({ modkey, "Shift" }, "w", function(c) awesome.kill(c.pid, 9) end,
...
client.connect_signal("unfocus", function(c)
	...
	if c.class == "jetbrains-toolbox" then
		c:kill()
	end
end)
