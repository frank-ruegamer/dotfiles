# Generated by Powerlevel10k configuration wizard on 2023-09-06 at 12:58 CEST.
...
() {
  ...
  #
  #   1. A pattern against which the yurrent directory ($PWD) is matched. Matching is done with
